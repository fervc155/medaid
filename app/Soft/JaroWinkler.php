...
class JaroWinkler  
{
 ...
 public static function Jaro( $string1, $string2 ){
  ...
  $commons1 = JaroWinkler::getCommonCharacters( $string1, $string2, $distance );
  $commons2 = JaroWinkler::getCommonCharacters( $string2, $string1, $distance );
 ...
 public static function JaroWinkler($string1, $string2, $PREFIXSCALE = 0.1 ){
  ...
  $JaroDistance = JaroWinkler::Jaro( $string1, $string2 );
  
  $prefixLength = JaroWinkler::getPrefixLength( $string1, $string2 );
